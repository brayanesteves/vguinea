...
<head>
  ...
  <link href="css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <link href='libs/HTML&CSS&JS/fullcalendar/css/fullcalendar.css' rel='stylesheet' />
</head>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="modelos.php">Modelos</a>
            <a class="collapse-item" href="escenarios.php">Escenarios</a>
