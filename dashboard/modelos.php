...
$consulta = "SELECT * FROM `0_Mdls` WHERE `Cndtn` = 1 AND `Rmvd` = 0 AND `Lckd` = 0;";
...
<div class="container">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevoModelo" type="button" class="btn btn-success" data-toggle="modal">Nuevo modelo</button>    
            </div>    
        </div>    
    </div>    
    <br>  
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="TblMdls" class="table table-striped table-bordered table-condensed" style="width:100%">
...
<!--Modal para CRUD-->
<div class="modal fade" id="WndwsMdls" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
